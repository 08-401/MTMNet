...
def parse_opts():
    parser = argparse.ArgumentParser(description='MTMNet: Multi-task Learning with Minimal Data for Source-free Cross-domain Few-shot Semantic Segmentation')
    parser.add_argument('--benchmark', type=str, default='wbc',choices=['fss', 'deepglobe', 'lung', 'isic','wbc','tcia','kvasir'])
    parser.add_argument('--datapath', type=str, default=r"F:\\*****\\CDFSSDataSet\\Target domains")
